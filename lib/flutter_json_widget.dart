...
class JsonViewerWidget extends StatefulWidget {
  ...
  JsonViewerWidget(this.jsonObj, {this.initiallyExpanded});
...
class JsonViewerWidgetState extends State<JsonViewerWidget> {
  ...
  static getContentWidget(dynamic content) {
    if (content is List) {
      return JsonArrayViewerWidget(content, initiallyExpanded: true);
    } else {
      return JsonViewerWidget(content, initiallyExpanded: true);
    }
  }
...
class JsonArrayViewerWidget extends StatefulWidget {
  ...
  JsonArrayViewerWidget(this.jsonArray, {this.initiallyExpanded});
